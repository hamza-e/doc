	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Doctors': [
				{
					name: 'Dr. Simo 6',
					location_latitude: 31.6342112, 
					location_longitude: -8.0127213,
					map_image_url: 'assets/images/1544202296.jpg',
					type: 'something',
					url_detail: 'detail-page.html',
					name_point: 'Dr. simo',
					description_point: 'gueliz marrakech',
			...
			var mapOptions = {
				zoom: 10,
				center: new google.maps.LatLng(31.6345001,-8.0778941),
